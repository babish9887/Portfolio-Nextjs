...
const HomePage = () => {
  ...
  return (
    <div id='home' className='  flex flex-col justify-center items-center p-10 pb-4 gap-y-5 mt-[50px] sm:mt-[80px] '>
            <div data-scroll data-scroll-speed={0.2} className="z-0  image opacity-0 h-[20rem] sm:h-[22rem] lg:h-[23rem] xl:h-[24rem] aspect-square rounded-full overflow-hidden">
            ...
            <div className="info  flex justify-center flex-col items-center gap-y-3">
                  <p data-scroll data-scroll-speed={0.15} className='hello opacity-0 text-lg text-cyan-400'>Hello</p>
                  <h1 data-scroll data-scroll-speed={0.10} className='text2 opacity-0 text-[4rem] font-bold m-0 p-0 text-center'>I'm <span className='text-cyan-400'>Babish</span></h1>
                  <p data-scroll data-scroll-speed={0.05} className='text-center opacity-0 w-full max-w-[850px] text-xl'>I'm a passionate web developer from Nepal, skilled in both front-end and back-end technologies, dedicated to crafting seamless and dynamic digital experiences that reflect my commitment to innovation and excellence.</p>
